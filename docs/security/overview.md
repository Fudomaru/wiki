...
- [**Footprinting**](footprinting.md) → deep-dive into the full enumeration methodology: infrastructure, host, and OS enumeration covering all major services and protocols.  
